...
package ai.starwhale.mlops.domain.job.step.task.status;
...
import static ai.starwhale.mlops.domain.job.step.task.status.TaskStatus.UNKNOWN;
...
public class TaskStatusMachine {
    ...
    public static boolean couldTransfer(TaskStatus statusNow, TaskStatus statusNew) {
