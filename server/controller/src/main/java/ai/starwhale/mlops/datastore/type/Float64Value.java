...
@AllArgsConstructor
@EqualsAndHashCode
public class Float64Value implements FloatValue {
    ...
    public Object encode(boolean rawResult) {
        if (rawResult) {
            ...
            return StringUtils.leftPad(Long.toHexString(Double.doubleToLongBits(this.value)), 16, "0");
        }
    }

    @Override
    public Wal.Column.Builder encodeWal() {
        return Wal.Column.newBuilder().setDoubleValue(this.value);
    }
