...
public class RollingUpdateController {
    ...
    public RollingUpdateController(RollingUpdateStatusListeners rollingUpdateStatusListeners) {
    ...
    public ResponseEntity<ResponseMessage<String>> instanceStatus(
            ServerInstanceStatus status,
            InstanceType instanceType
    ) {
        try {
            if (instanceType == InstanceType.NEW) {
                rollingUpdateStatusListeners.onNewInstanceStatus(status);
            } else if (instanceType == InstanceType.OLD) {
                rollingUpdateStatusListeners.onOldInstanceStatus(status);
            } else {
