...
@Order(1)
@Component
public class DatasetBuildTaskSpecificationFactory implements TaskContainerSpecificationFactory {
    ...
    public DatasetBuildTaskSpecificationFactory(SystemSettingService systemSettingService,
            TaskTokenValidator taskTokenValidator, @Value("${sw.instance-uri}") String instanceUri) {
    ...
    public ContainerSpecification containerSpecificationOf(Task task) {
        return new DatasetBuildContainerSpecification(systemSettingService, instanceUri, taskTokenValidator, task);
    }
