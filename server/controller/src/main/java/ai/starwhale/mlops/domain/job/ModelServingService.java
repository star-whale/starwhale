...
public class ModelServingService {
    ...
    private void deploy(
        ...
        envs.put("SW_RUNTIME_PYTHON_VERSION", runtime.getVersionMetaObj().getEnvironment().getPython());
        envs.put("SW_VERSION", runtime.getVersionMetaObj().getEnvironment().getLock().getSwVersion());
