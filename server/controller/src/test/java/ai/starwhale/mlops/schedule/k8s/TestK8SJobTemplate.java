...
public class TestK8SJobTemplate {
    ...
    public void testRender(){
        ...
        Assertions.assertIterableEquals(List.of(new V1EnvVar().name("env1").value("env1value")
            , new V1EnvVar().name("env2").value("env2value")),workerC.getEnv());
        ...
        Assertions.assertIterableEquals(List.of(new V1EnvVar().name("envx").value("envxvalue")
            , new V1EnvVar().name("envy").value("envyvalue")),dpC.getEnv());
    }
