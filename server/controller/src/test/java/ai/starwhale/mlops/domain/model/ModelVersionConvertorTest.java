...
public class ModelVersionConvertorTest {

    private ModelVersionConvertor modelVersionConvertor;
    ...
    public void setUp() {
        ...
        modelVersionConvertor = new ModelVersionConvertor(
                new IdConvertor(),
                userConvertor,
    ...
    public void testConvert() {
        var res = modelVersionConvertor.convert(ModelVersionEntity.builder()
                .id(1L)
                .versionName("name1")
                .versionOrder(2L)
    ...
    public void testRevert() {
        assertThrows(UnsupportedOperationException.class,
                () -> modelVersionConvertor.revert(ModelVersionVo.builder().build()));
    }
}
