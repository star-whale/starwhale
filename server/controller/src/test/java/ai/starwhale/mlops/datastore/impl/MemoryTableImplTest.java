    ...
    public class QueryScanTest {
        ...
        public void testQueryFilterInt16Less() {
            ...
            var results = this.memoryTable.query(
                    ...
                    false);
            assertThat(results,
                    is(List.of(new MemoryTable.RecordResult(9, Map.of("c", (short) 0)),
        ...
        public void testQueryFilterInt32Less() {
            ...
            var results = this.memoryTable.query(
                    ...
                    false);
            assertThat(results,
                    is(List.of(new MemoryTable.RecordResult(8, Map.of("d", 0)),
        ...
        public void testQueryFilterInt64Less() {
            ...
            var results = this.memoryTable.query(
                    ...
                    false);
            assertThat(results,
                    is(List.of(new MemoryTable.RecordResult(7, Map.of("e", 0L)),
        ...
        public void testQueryFilterFloat32Less() {
            ...
            var results = this.memoryTable.query(
                    ...
                    false);
            assertThat(results,
                    is(List.of(new MemoryTable.RecordResult(6, Map.of("f", 0.f)),
        ...
        public void testQueryFilterFloat64Less() {
            ...
            var results = this.memoryTable.query(
                    ...
                    false);
            assertThat(results,
                    is(List.of(new MemoryTable.RecordResult(5, Map.of("g", 0.)),
        ...
        public void testQueryFilterStringLess() {
            ...
            var results = this.memoryTable.query(
                    ...
                    false);
            assertThat(results,
                    is(List.of(new MemoryTable.RecordResult(4, Map.of("h", "0")),
        ...
        public void testQueryFilterBytesLess() {
            ...
            var results = this.memoryTable.query(
                    ...
                    false);
            assertThat(results,
                    is(List.of(new MemoryTable.RecordResult(3,
