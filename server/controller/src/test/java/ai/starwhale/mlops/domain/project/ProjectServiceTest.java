...
public class ProjectServiceTest {
    ...
    public void setUp() {
        ...
        ProjectRoleConvertor projectRoleConvertor = new ProjectRoleConvertor(idConvertor, projectConvertor, roleConvertor, userConvertor);
    ...
    public void testModifyProject() {
        given(projectMapper.modifyProject(argThat(p -> p.getId() == 1L)))
            .willReturn(1);
//        given(projectMapper.modifyProject(argThat(p -> p.getId() == 99L)))
//            .willReturn(0);
//        given(projectMapper.modifyProject(argThat(p -> p.getProjectName().equals("exist_project"))))
