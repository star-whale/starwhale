...
public class JobServiceTest {
    ...
    public void testCreateJob() {
        ...
        assertThrows(StarwhaleApiException.class, () -> service.createJob("1", "3", "1", "2",
                "", "1", "", "", JobType.EVALUATION, DebugWay.VS_CODE, false, ""));

        assertThrows(StarwhaleApiException.class, () -> service.createJob("1", "3", "1", "2",
                "", "1", "h", "s", JobType.EVALUATION, DebugWay.VS_CODE, false, ""));

        assertThrows(SwValidationException.class, () -> service.createJob("1", "3", "1", "",
                "", "1", "h", "s", JobType.EVALUATION, DebugWay.VS_CODE, false, ""));

        var res = service.createJob("1", "3", "1", "2",
                 "", "1", "mnist.evaluator:MNISTInference.cmp", "", JobType.EVALUATION, DebugWay.VS_CODE, false, "");
        assertThat(res, is(1L));

        res = service.createJob("1", "3", "1", "2",
                "", "1", "", overviewJobSpec, JobType.FINE_TUNE, DebugWay.VS_CODE, false, "");
        assertThat(res, is(1L));
    }
