...
package ai.starwhale.mlops.domain.dataset.convertor;
...
public class DatasetVersionConvertorTest {

    private DatasetVersionConvertor datasetVersionConvertor;
    ...
    public void setUp() {
        ...
        datasetVersionConvertor = new DatasetVersionConvertor(
                new IdConvertor(),
                userConvertor,
    ...
    public void testConvert() {
        var res = datasetVersionConvertor.convert(DatasetVersionEntity.builder()
                .id(1L)
                .versionName("name1")
                .versionOrder(2L)
    ...
    public void testRevert() {
        assertThrows(UnsupportedOperationException.class,
                () -> datasetVersionConvertor.revert(DatasetVersionVo.builder().build()));
    }
}
