...
public class RuntimeConvertorTest {

    private RuntimeConvertor convertor;

    @BeforeEach
    public void setUp() {
        UserConvertor userConvertor = mock(UserConvertor.class);
        given(userConvertor.convert(any())).willReturn(UserVo.empty());
        convertor = new RuntimeConvertor(new IdConvertor(), userConvertor);
    }
    ...
    public void testRevert() {
        assertThrows(UnsupportedOperationException.class,
                () -> convertor.revert(RuntimeVo.builder().build()));
    }
}
