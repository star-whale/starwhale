...
package ai.starwhale.mlops.storage.autofit.ksyun;
...
public class CompatibleStorageAccessServiceBuilderKsyun implements CompatibleStorageAccessServiceBuilder {

    public static final Set<String> TYPES = Set.of("ksyun", "ks3");
    ...
    public CompatibleStorageAccessService build(Map<String, String> connectionToken) {
        ...
        return new CompatibleStorageAccessServiceS3Like(new StorageAccessServiceKsyun(s3Config), s3Config, TYPES);
    }
