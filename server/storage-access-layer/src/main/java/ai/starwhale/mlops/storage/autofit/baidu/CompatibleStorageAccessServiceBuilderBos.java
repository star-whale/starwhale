...
package ai.starwhale.mlops.storage.autofit.baidu;
...
public class CompatibleStorageAccessServiceBuilderBos implements CompatibleStorageAccessServiceBuilder {

    public static final Set<String> TYPES = Set.of("baidu");
    ...
    public CompatibleStorageAccessService build(Map<String, String> connectionToken) {
        ...
        return new CompatibleStorageAccessServiceS3Like(new StorageAccessServiceBos(s3Config), s3Config, TYPES);
    }
