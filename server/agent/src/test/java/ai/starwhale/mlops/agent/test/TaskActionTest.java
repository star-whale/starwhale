...
public class TaskActionTest {
    ...
    @Test
    public void testPreparing2Running() {
        mockConfig();
        List<EvaluationTask> tasks = List.of(
                EvaluationTask.builder()
                        ...
                        .deviceAmount(1)
                        .imageId("starwhaleai/starwhale:0.1.0-nightly-2022041203") //todo by args
                ...
                List.of(
                        EvaluationTask.builder()
                                ...
                                .swModelPackage(SWModelPackage.builder()
                                        ...
                                        .name("test-swmp")
                                        .version("v1")
                                        .path("StarWhale/controller/swmp/mnist/meytmy3dge4gcnrtmftdgyjzoazxg3yStarWhale/controller/swmp/mnist/meytmy3dge4gcnrtmftdgyjzoazxg3y")
                                        .build())
                                .resultPath("todo")
                                .build()
                ))
