...
@click.option("--page", type=int, default=DEFAULT_PAGE_NUM, help="page number for projects list")
@click.option("--size", type=int, default=DEFAULT_PAGE_SIZE, help="page size for projects list")
...
@click.option("--dataset", required=True, multiple=True, help="local storeage dataset [name]:[version], one or more")
@click.option("--baseimage", default=DEFAULT_SW_TASK_RUN_IMAGE, help="task baseimage name")
...
@click.option("--resource", default="cpu:1", help="resource, fmt is resource [name]:[cnt], such as cpu:1, gpu:2")
@click.option("--name", help="evaluation job name")
@click.option("--desc", help="evaluation job description")
