...
class PipelineHandler(metaclass=ABCMeta):
    ...
    def __init__(
        ...
        **kwargs: t.Any,
        ...
        self.evaluation_store = EvaluationLogStore(
            id=self.context.version, project=self.context.project
        )
    ...
    def _do_evaluate(self) -> t.Any:
        ...
        if self.predict_auto_log:
            func(self._iter_predict_result(self.evaluation_store._iter_results()))
        else:
            func()
    ...
    def _starwhale_internal_run_predict(self) -> None:
        ...
        if self.predict_auto_log:
            self.evaluation_store._flush_result()
