...
export default {
    ...
    moduleNameMapper: {
        ...
        '^@/(.*)': '<rootDir>/src/$1',
        '^@base/(.*)': '<rootDir>/src/domain/base/$1',
        '^@runtime/(.*)': '<rootDir>/src/domain/runtime/$1',
        '^@dataset/(.*)': '<rootDir>/src/domain/dataset/$1',
        '^@job/(.*)': '<rootDir>/src/domain/job/$1',
    ...
    testPathIgnorePatterns: ['/node_modules/', '/playwright/', '/stories/'],
