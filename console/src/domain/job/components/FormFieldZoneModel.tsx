...
import SpaceModelTreeSelector from '@/domain/space/components/SpaceModelTreeSelector'
        ...
        <>
            <div className={styles.modelField}>
                <FormItem label={t('Model Version')} required name='modelVersionUrl'>
                    <SpaceModelTreeSelector projectId={projectId} spaceId={spaceId} onDataChange={setModelTree} />
                </FormItem>
...
export default FormFieldZoneModel
