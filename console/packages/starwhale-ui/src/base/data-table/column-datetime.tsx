...
import {
    ...
    addDays,
    // @ts-ignore
} from 'baseui/datepicker/utils'
import { Datepicker } from 'baseui/datepicker'
import { TimePicker } from 'baseui/timepicker'
import { useStyletron } from 'baseui'
import { Select } from 'baseui/select'
import type { Value as ValueT } from 'baseui/select'
...
function DatetimeFilter(props: any) {
    const [css, theme] = useStyletron()
    ...
    const [categoricalOperator, setCategoricalOperator] = React.useState<ValueT>([initialState.categoricalOperator])
    // flowlint-next-line unclear-type:off
                    ...
                    <div>
                        <Select
                            ...
                            options={RANGE_OPERATIONS.map((op) => ({
                                // @ts-ignore
                                label: locale.datatable[op.localeLabelKey] as any,
                                id: op.id,
                            }))}
                            size='compact'
                            clearable={false}
