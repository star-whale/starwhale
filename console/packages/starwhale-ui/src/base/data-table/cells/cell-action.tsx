...
function CellAction({ columnIndex, rowIndex, data, style }: any) {
    ...
    const Cell = React.useMemo(() => column.renderAction ?? null, [column])
...
function compareCellAction(prevProps: any, nextProps: any) {
...
const CellActionMemo = React.memo<CellActionPropsT>(CellAction, compareCellAction)

export default CellActionMemo
