...
import { SIZE, CLOSE_SOURCE, ANCHOR } from 'baseui/drawer/constants'
import {
    StyledRoot,
    StyledBackdrop,
    ...
    StyledClose,
    Hidden,
} from 'baseui/drawer/styled-components'
import { CloseIcon } from 'baseui/drawer/close-icon'

import type { DrawerProps, DrawerState, SharedStylePropsArg, CloseSource, ElementRef } from 'baseui/drawer/types'
