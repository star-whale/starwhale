...
export default class SelectDropdown extends React.Component<DropdownProps> {
    ...
    render() {
        ...
        const { maxDropdownHeight, multi, noResultsMsg, onItemSelect, options = [], overrides = {}, size } = this.props
        ...
        const [OverriddenStatefulMenu, { overrides: statefulMenuOverrides = {}, ...restStatefulMenuProps }] =
