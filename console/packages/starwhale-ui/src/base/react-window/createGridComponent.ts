    ...
    return class Grid<T> extends PureComponent<Props<T>, State> {
        ...
        _getHorizontalRangeToRender(): [number, number, number, number] {
            ...
            const overscanBackward =
                !isScrolling || horizontalScrollDirection === 'backward' ? Math.max(1, overscanCountResolved) : 1
            const overscanForward =
                !isScrolling || horizontalScrollDirection === 'forward' ? Math.max(1, overscanCountResolved) : 1
            return [
        ...
        _getVerticalRangeToRender(): [number, number, number, number] {
            ...
            // If there isn't at least one extra item, tab loops back around.
            const overscanBackward =
                !isScrolling || verticalScrollDirection === 'backward' ? Math.max(1, overscanCountResolved) : 1
            const overscanForward =
                !isScrolling || verticalScrollDirection === 'forward' ? Math.max(1, overscanCountResolved) : 1
            return [
                Math.max(0, startIndex - overscanBackward),
