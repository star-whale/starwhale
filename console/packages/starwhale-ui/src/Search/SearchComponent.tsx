...
import TriangleDownIcon from 'baseui/icon/triangle-down'
import SearchIconComponent from 'baseui/icon/search'
...
import { TYPE, STATE_CHANGE_TYPE, SIZE } from '../base/select/constants'
import defaultProps from '../base/select/default-props'
...
} from '../base/select/styled-components'
import type { SelectProps, SelectState, Value, Option, ChangeAction } from '../base/select/types'
import { expandValue, normalizeOptions } from '../base/select/utils'
...
class Search extends React.Component<SelectProps, SelectState> {
        ...
        switch (event.keyCode) {
            ...
            case 9: // tab
                this.setState((prevState) => ({
                    ...
                    isOpen: false,
                    inputValue:
                        !this.props.onCloseResetsInput || !this.props.onBlurResetsInput ? prevState.inputValue : '',
                }))
                break
            case 27: // escape
                ...
                {(listboxId: string) => (
                    <LocaleContext.Consumer>
                        {(locale) => (
                            ...
                            >
                                {/* @ts-ignore TS2786 error with web-eats-v2, can remove once React 18 migration complete */}
                                <Root onBlur={this.handleBlur} data-baseweb='select' {...sharedProps} {...rootProps}>
                                    {/* @ts-ignore TS2786 error with web-eats-v2, can remove once React 18 migration complete */}
                                    <ControlContainer
