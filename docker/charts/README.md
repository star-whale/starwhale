...
| `controller.storageType` | Starwhale supports `s3`, `minio`, `aliyun` and `fs` as the main storage. | `s3` |
...
- Welcome to your pull request, [Github Repo](https://github.com/star-whale/starwhale).
