...
with PILImage.open(io.BytesIO(albedo0)) as img1, PILImage.open(io.BytesIO(clean0)) as img2, PILImage.open(
    io.BytesIO(final0)) as img3, PILImage.open(io.BytesIO(albedo1)) as img4, PILImage.open(
    io.BytesIO(final1)) as img5, PILImage.open(io.BytesIO(clean1)) as img6, PILImage.open(
    io.BytesIO(flow_viz)) as img7, PILImage.open(
    io.BytesIO(pix_occlusions)) as img9:
